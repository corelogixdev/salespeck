...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    let _permissions = [
      ...
      { id: generateId(32), name: 'vendors', description: 'vendor' },
      { id: generateId(32), name: 'vendors.create', description: 'vendor create' },
      { id: generateId(32), name: 'vendors.update', description: 'vendor update' },
      { id: generateId(32), name: 'vendors.delete', description: 'vendor delete' },
      { id: generateId(32), name: 'vendors.view', description: 'vendor view' },
      { id: generateId(32), name: 'vendors.list', description: 'vendor list' },
      { id: generateId(32), name: 'vendors.search', description: 'vendor search' },
