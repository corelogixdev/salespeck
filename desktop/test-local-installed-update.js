...
const INSTALLED_SETTINGS_PATH = path.join(process.env.APPDATA || path.join(os.homedir(), 'AppData', 'Roaming'), 'openmenu', '.settings');
...
function showInstructions() {
  ...
  log('2. Open the installed OpenMenu app.', 'yellow');
